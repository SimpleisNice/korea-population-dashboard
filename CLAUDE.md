...
- `docs/domain.md` — 도메인 정의와 스코프 경계. 새 기능 영역을 제안하기 전에 확인
- `docs/spec.md` — 살아있는 기능 명세(페이지·컴포넌트·데이터 함수). 사용자 대상 기능을 낼 때 갱신
- `docs/principles.md` — 이 서비스의 원리·원칙(데이터·UI·성능·수익화). 설계 판단이 갈릴 때 기준
- `docs/backlog.md` — 개선 과제와 신규 서비스 후보, 우선순위
